...
export declare class PromiseDfsApi {
    ...
    getBalanceHistory(apiKey: string, _options?: Configuration): Promise<GetBalanceHistoryResponseModel>;
    ...
    v1UserBalanceHistoryOptions(_options?: Configuration): Promise<void>;
