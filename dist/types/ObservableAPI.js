...
exports.ObservableDfsApi = void 0;
var rxjsStub_1 = require("../rxjsStub");
var rxjsStub_2 = require("../rxjsStub");
var DfsApi_1 = require("../apis/DfsApi");
var ObservableDfsApi = (function () {
    function ObservableDfsApi(configuration, requestFactory, responseProcessor) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new DfsApi_1.DfsApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new DfsApi_1.DfsApiResponseProcessor();
    }
    ObservableDfsApi.prototype.buyAsset = function (apiKey, buyAssetRequestModel, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.buyAsset(apiKey, buyAssetRequestModel, _options);
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)(function (rsp) { return _this.responseProcessor.buyAsset(rsp); }));
        }));
    };
    ObservableDfsApi.prototype.getAvaliableAssets = function (apiKey, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getAvaliableAssets(apiKey, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
        ...
        return middlewarePreObservable.pipe((0, rxjsStub_2.mergeMap)(function (ctx) { return _this.configuration.httpApi.send(ctx); })).
            ...
            return middlewarePostObservable.pipe((0, rxjsStub_2.map)(function (rsp) { return _this.responseProcessor.getAvaliableAssets(rsp); }));
        }));
    };
    ObservableDfsApi.prototype.getAvaliableBalance = function (apiKey, _options) {
        var _this = this;
        var requestContextPromise = this.requestFactory.getAvaliableBalance(apiKey, _options);
        var middlewarePreObservable = (0, rxjsStub_1.from)(requestContextPromise);
    ...
    return ObservableDfsApi;
}());
exports.ObservableDfsApi = ObservableDfsApi;
