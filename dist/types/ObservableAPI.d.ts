...
export declare class ObservableDfsApi {
    ...
    getBalanceHistory(apiKey: string, _options?: Configuration): Observable<GetBalanceHistoryResponseModel>;
    ...
    v1UserBalanceHistoryOptions(_options?: Configuration): Observable<void>;
