...
export declare class DfsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getBalanceHistory(apiKey: string, _options?: Configuration): Promise<RequestContext>;
    ...
    v1UserBalanceHistoryOptions(_options?: Configuration): Promise<RequestContext>;
...
export declare class DfsApiResponseProcessor {
    ...
    getBalanceHistory(response: ResponseContext): Promise<GetBalanceHistoryResponseModel>;
    ...
    v1UserBalanceHistoryOptions(response: ResponseContext): Promise<void>;
